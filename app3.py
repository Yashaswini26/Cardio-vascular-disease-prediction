...
app = Flask(__name__,template_folder='/Users/yashaswinireddy/Desktop/DAM/Flask-master/template') #Initialize the flask App
...
def predict():
    ...
    if output==0:
        output = "Negative"
    return render_template('index2.html', prediction_text='Chances of getting Cardio Vascular Diseases  is {}  '.format(output))
